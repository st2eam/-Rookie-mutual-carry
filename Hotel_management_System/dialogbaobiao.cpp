...
#include "ui_dialogbaobiao.h"

Dialogbaobiao::Dialogbaobiao(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialogbaobiao)
{//预定客人报表
    ui->setupUi(this);
...
//    model->setHeaderData(4,Qt::Horizontal,"VIP号码");
    model->setHeaderData(2,Qt::Horizontal,"入住房间");
    model->setHeaderData(3,Qt::Horizontal,"预定入住");
    model->setHeaderData(4,Qt::Horizontal,"预定离开");
