...
#include "ui_dialogbaobiao4.h"

Dialogbaobiao4::Dialogbaobiao4(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialogbaobiao4)
{//当日离店客人报表
    ui->setupUi(this);
...
//    model->setHeaderData(8,Qt::Horizontal,"入住时间");
    model->setHeaderData(1,Qt::Horizontal,"离开时间");
