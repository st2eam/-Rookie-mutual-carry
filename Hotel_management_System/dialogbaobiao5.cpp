...
#include "ui_dialogbaobiao5.h"

Dialogbaobiao5::Dialogbaobiao5(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::Dialogbaobiao5)
{//当日财务进账报表
    ui->setupUi(this);
...
//    model->setHeaderData(7,Qt::Horizontal,"预定离开");
      model->setHeaderData(1,Qt::Horizontal,"入住时间");
//    model->setHeaderData(9,Qt::Horizontal,"离开时间");
      model->setHeaderData(2,Qt::Horizontal,"应缴金额");
